...
public class JdbcMemberRepository implements MemberRepository {
    ...
    public Member save(Member member) {
        ...
        try {
            ...
            if (rs.next()) { member.setId(rs.getLong(1)); } else { throw new SQLException("id 조회 실패"); }
            return member;
        } catch (Exception e) { throw new IllegalStateException(e); } finally { close(conn, pstmt, rs); }
    }
